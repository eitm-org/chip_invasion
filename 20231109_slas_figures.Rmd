...
cute_surface_maker_newbie(fig2_boundary$huvec_list, fig2_boundary$fit_list, chip_in = 1, bottom_gfp_df = fig2_counts$all_gfp_bottom) #thats better - perhaps swap surface, not points?
